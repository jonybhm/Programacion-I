...
class Auxiliar:
    @staticmethod
    def getAnimationListFromSpriteSheet(path,columnas,filas,flip=False, step = 1,scale=1):
        lista = []
...
def show_text_on_screen(x,y,text,screen):
    font = pygame.font.Font(PATH + r"\\font\\alagard.ttf",25)
